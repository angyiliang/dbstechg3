...
// public facing function to start  plotting default graph
function get_line_diagram(startDate, endDate, hlevel, showMonth, customData){
    ...
    let data = $.getJSON("./data/sort_by_date.json", function(json) {
        ...
        if( hlevel == 0){
            compiledData = CompileAllDiseasesForLine(json, start, end, showMonth, customData);
        } else if (hlevel == 1){
            compiledData = CompileDiseaseCategoryForLine(json, start, end, showMonth, customData);
        } else if (hlevel == 2){
            compiledData = CompileDiseaseNameForLine(json, start, end, showMonth, customData);
        }

        reload_line_graph(start, end, compiledData, showMonth);
    });
}
...
function reload_line_graph(startDate, endDate, compiledData, showMonth){
...
function CompileAllDiseasesForLine(jsonData, start, end, showMonth, customData){
    var compiled = {};
    var years = [];
    var months = [];
    var highest = 0;
...
function CompileDiseaseCategoryForLine(jsonData, start, end, showMonth, customData){
    var compiled = {};
    var years = [];
    var months = [];
    var highest = 0;
...
function CompileDiseaseNameForLine(jsonData, start, end, showMonth, customData){
    var compiled = {};
    var years = [];
    var months = [];
    var highest = 0;
